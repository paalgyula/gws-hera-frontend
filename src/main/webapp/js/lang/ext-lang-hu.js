...
if(Ext.DatePicker){
  Ext.apply(Ext.DatePicker.prototype, {
    ...
    maxText           : "A dátum kés?bbi a megengedettnél",
    disabledDaysText  : "",
    disabledDatesText : "",
    monthNames        : Date.monthNames,
    dayNames          : Date.dayNames,
    nextText          : 'Köv. hónap (CTRL+Jobbra)',
    prevText          : 'El?z? hónap (CTRL+Balra)',
...
if(Ext.PagingToolbar){
  Ext.apply(Ext.PagingToolbar.prototype, {
    ...
    displayMsg     : "{0} - {1} sorok láthatók a {2}-ból/b?l",
    emptyMsg       : 'Nincs megjeleníthet? adat'
  });
}

if(Ext.form.TextField){
  Ext.apply(Ext.form.TextField.prototype, {
    minLengthText : "A mez? tartalma legalább {0} hosszú kell legyen",
    maxLengthText : "A mez? tartalma legfeljebb {0} hosszú lehet",
    blankText     : "Kötelez?en kitöltend? mez?",
    regexText     : "",
    emptyText     : null
  });
}
...
if(Ext.form.DateField){
  Ext.apply(Ext.form.DateField.prototype, {
    ...
    maxText           : "A dátum nem lehet kés?bbi, mint {0}",
    invalidText       : "{0} nem megfelel? dátum - a helyes formátum: {1}",
    format            : "Y m d",
...
if(Ext.form.VTypes){
  Ext.apply(Ext.form.VTypes, {
    emailText    : 'A mez? email címet tartalmazhat, melynek formátuma "felhasználó@szolgáltató.hu"',
    urlText      : 'A mez? webcímet tartalmazhat, melynek formátuma "http:/'+'/www.weboldal.hu"',
    alphaText    : 'A mez? csak bet?ket és aláhúzást (_) tartalmazhat',
    alphanumText : 'A mez? csak bet?ket, számokat és aláhúzást (_) tartalmazhat'
  });
}
...
if(Ext.form.HtmlEditor){
  Ext.apply(Ext.form.HtmlEditor.prototype, {
    ...
    buttonTips : {
      ...
      italic : {
        title: 'D?lt (Ctrl+I)',
        text: 'D?lté teszi a kijelölt szöveget.',
        cls: 'x-html-editor-tip'
      },
      underline : {
...
if(Ext.grid.GridView){
  Ext.apply(Ext.grid.GridView.prototype, {
    sortAscText  : "Növekv? rendezés",
    sortDescText : "Csökken? rendezés",
