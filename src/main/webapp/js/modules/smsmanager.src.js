/**
 * @author goofy
 * @classDescription SMS Main window
 */
var smsmanagerwindow = null;

function GenerateSMSGrid(){
    url = 'ajax/SMS/simplesmslist.php';
    baseParameters = {};
    ...
    return new Ext.grid.GridPanel({
        ...
        columns: [new Ext.grid.RowNumberer({
            ...
            renderer: function(val){
                return "<img src='images/icons/" + (val == 'yes' ? 'accept.png' : 'delete.png') + "'/>";
            }
        }, {
            ...
            dataIndex: 'provider',
            renderer: function(val){
                return "<img src='images/providers/" + val + ".png' alt='' title=''/>";
            }
        }, {
            ...
            tbar: [{
                ...
                items: [{
                    ...
                    menu: [{
                        ...
                        handler: function(){
                            smsmanagerwindow.items.clear();
                            smsmanagerwindow.items.add(GenerateSMSGrid('smslistbyprefix.php', {
                                ...
                                items: [{
                                    ...
                                    listeners: {
                                        select: function(field, newValue, oldValue){
                                            Ext.get('answertext').update(newValue.data.answer);
                                            if (typeof newValue.data.url == "object") {
                                                Ext.getCmp('answerurl').setValue();
                                            }
                                            else {
                                                Ext.getCmp('answerurl').setValue(newValue.data.url);
                                            }
                                        }
                                    },
                                    triggerAction: 'all',
                                ...
                                buttons: [{
                                    ...
                                    handler: function(){
                                        newprefixform.getForm().submit({
                                            ...
                                            url: 'ajax/SMS/editprefix.php',
                                            success: function(){
                                                // Editalando prefixek ujratoltese, nehogy a regi ertek jojjon vissza
                                            ...
                                            failure: function(request, form){
                                                Ext.MessageBox.show({
                                                    title: Lang.ERROR,
                                                    msg: 'Belso hiba miatt nem sikerult tarolni a modositasokat. Szerver hibauzenet:<br/><b>' + Ext.util.JSON.decode(form.response.responseText).errorString + '</b>',
                                ...
                                buttons: [{
                                    ...
                                    handler: function(){
                                        testprefixform.getForm().submit({
                                            waitMsg: Lang.loadinprogress,
                                            url: 'ajax/SMS/testprefix.php',
                                            params: {
                                                text: Ext.get('SMSTesztPrefix').getValue() + " " + Ext.get('SMSTesztData').getValue(),
                                                category: Ext.get('SMSTesztCategory').getValue()
                                            },
                                            success: function(field, result){
                                                Ext.get('SMSTesztAnswer').update(Ext.util.JSON.decode(result.response.responseText).responseText);
                                            },
                                            failure: function(){
